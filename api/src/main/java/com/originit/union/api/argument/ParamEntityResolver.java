package com.originit.union.api.argument;

import com.originit.union.api.annotation.ParamModel;
...
@Slf4j
public class ParamEntityResolver implements HandlerMethodArgumentResolver {
    @Override
