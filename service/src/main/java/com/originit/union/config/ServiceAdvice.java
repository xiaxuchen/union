...
public class ServiceAdvice {
    ...
    public Object validateService (ProceedingJoinPoint point) throws Throwable {
        ...
        final List<? extends Class<?>> parameterTypes = Arrays.stream(args).map(Object::getClass).collect(Collectors.toList());
        Class [] paramTypeArray = new Class[parameterTypes.size()];
        parameterTypes.toArray(paramTypeArray);
